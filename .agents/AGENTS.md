...
- Implementar el patrón de Event Driven para mantener un
registro de todos los cambios en los fichajes de los
empleados a lo largo del tiempo. Esto puede agregar un
valor significativo al sistema al permitir una auditoría
completa de los datos.
- Implementar el patrón CQRS para separar
las operaciones de lectura (queries) de las operaciones de
escritura (commands), lo que puede mejorar la
